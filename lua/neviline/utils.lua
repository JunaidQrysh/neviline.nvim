...
---@type NeviLineUtils
local M = {
	ignored = require("neviline.ignored").ignored,
	...
	mode_color = {
		...
		["nt"] = {
			i("NORMAL", "vim-normal-mode", 0, 1) .. "-" .. i("TERMINAL", "vim-terminal-mode", 0, 1),
			"St_NTerminalMode",
		},
		["ntT"] = {
			i("NORMAL", "vim-normal-mode", 0, 1) .. "-" .. i("TERMINAL", "vim-terminal-mode", 0, 1) .. " (ntT)",
			"St_NTerminalMode",
		},
